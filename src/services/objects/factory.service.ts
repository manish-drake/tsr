...
export class Factory {
    ...
    createTestsData(test: string): Test {
        ...
        switch (test) {
            case '1090 ADS-B OUT': {
                newTest.Styles.add("key", "label95");
                ...
                add11.Key = "ADDRESS:";
                add11.Value = "______ (_) / ________ (_)";
                var cAdd11 = new TestParamCell(add11);
                cAdd11.Row = 0;
                cAdd11.Column = 0;
                cAdd11.ColSpan = 4;
                cAdd11.Styles.add("key", "label95");
                cAdd11.Styles.add("value", "result128");
                ...
                cFtid11.Row = 1;
                cFtid11.Column = 0;
                cFtid11.Styles.add("key", "label95");
                cFtid11.Styles.add("value", "result85");
                ...
                bssr11.Key = "BDS Rcvd (DF17):";
                bssr11.Value = "_,_ _,_ _,_ _,_ _,_";
                var cBssr11 = new TestParamCell(bssr11);
                cBssr11.Row = 2;
                cBssr11.Column = 0;
                cBssr11.ColSpan = 4;
                cBssr11.Styles.add("key", "label133");
                cBssr11.Styles.add("value", "result128");
                ...
                cFrre11.Column = 0;
                cFrre11.ColSpan = 4;
                cFrre11.Styles.add("key", "heading");
                ...
                apos.Styles.add("value", "result113Right");
                ...
                cFtid13.Row = 1;
                cFtid13.Column = 0;
                cFtid13.Styles.add("key", "label95");
                ...
                cBdsr13.Column = 0;
                cBdsr13.ColSpan = 4;
                cBdsr13.Styles.add("key", "label133");
                ...
                cNicsb13.Column = 0;
                cNicsb13.ColSpan = 2;
                cNicsb13.Styles.add("key", "label133");
                ...
                cCprf13.Column = 0;
                cCprf13.ColSpan = 2;
                cCprf13.Styles.add("key", "label133");
                ...
                cUttcs13.Column = 0;
                cUttcs13.ColSpan = 2;
                cUttcs13.Styles.add("key", "label133");
                ...
                var acid = new Test();
                acid.Name = "AC ID";
                acid.Styles.add("value", "result113Right");
                ...
                cBdsr14.Column = 0;
                cBdsr14.ColSpan = 4;
                cBdsr14.Styles.add("key", "label133");
                ...
                var vcty = new Test();
                vcty.Name = "VELOCITY";
                vcty.Styles.add("value", "result113Right");
                ...
                cBdsr15.Column = 0;
                cBdsr15.ColSpan = 4;
                cBdsr15.Styles.add("key", "label133");
                ...
                cIcf15.Row = 11;
                cIcf15.Column = 0;
                // cIcf15.Styles.add("key", "label133");
                ...
                cNacv15.Row = 12;
                cNacv15.Column = 0;
                // cNacv15.Styles.add("key", "label133");
                ...
                cFtid16.Row = 1;
                cFtid16.Column = 0;
                cFtid16.Styles.add("key", "label95");
                ...
                cBdsr16.Column = 0;
                cBdsr16.ColSpan = 4;
                cBdsr16.Styles.add("key", "label133");
                ...
                var result16 = new TestParam();
                result16.Key = "Result:";
                result16.Value = "______";
                var cResult16 = new TestParamCell(result16);
                cResult16.Row = 19;
                cResult16.Column = 0;
                cResult16.ColSpan = 4;
                ...
                ts.Styles.add("value", "result113Right");
                ...
                cFtid17.Row = 1;
                cFtid17.Column = 0;
                cFtid17.Styles.add("key", "label95");
                ...
                cBdsr17.Column = 0;
                cBdsr17.ColSpan = 4;
                cBdsr17.Styles.add("key", "label133");
                ...
                cTse17.Column = 0;
                cTse17.ColSpan = 2;
                cTse17.Styles.add("key", "labelAutoBold");
                ...
                cSelalt17.Row = 4;
                cSelalt17.Column = 0;
                cSelalt17.Styles.add("value", "result80Right");
                ...
                cBs17.Row = 5;
                cBs17.Column = 0;
                cBs17.Styles.add("value", "result80Right");
                ...
                cSelhd17.Row = 6;
                cSelhd17.Column = 0;
                cSelhd17.Styles.add("value", "result80Right");
                ...
                cMbs17.Column = 0;
                cMbs17.ColSpan = 2;
                cMbs17.Styles.add("key", "label133");
                ...
                cVnav17.Column = 0;
                cVnav17.ColSpan = 2;
                cVnav17.Styles.add("key", "label133");
                ...
                cAlt17.Column = 0;
                cAlt17.ColSpan = 2;
                cAlt17.Styles.add("key", "label133");
                ...
                cApp17.Column = 0;
                cApp17.ColSpan = 2;
                cApp17.Styles.add("key", "label133");
                ...
                cLnav17.Column = 0;
                cLnav17.ColSpan = 2;
                cLnav17.Styles.add("key", "label133");
                ...
                var sqtr = new Test();
                sqtr.Name = "SQUITTER";
                sqtr.Styles.add("value", "result113Right");
                ...
                cFtid18.Row = 1;
                cFtid18.Column = 0;
                cFtid18.Styles.add("key", "label95");
                ...
                cBdsr18.Column = 0;
                cBdsr18.ColSpan = 4;
                cBdsr18.Styles.add("key", "label133");
                ...
                cMfrq18.Row = 6;
                cMfrq18.Column = 0;
                cMfrq18.Styles.add("key", "label133");
            ...
            case 'UAT ADS-B OUT': {
                ...
                mst.Styles.add("value", "result113Right");
                ...
                cAddQ3.Column = 0;
                cAddQ3.ColSpan = 4;
                cAddQ3.Styles.add("key", "label133");
                ...
                cAgst1.Column = 0;
                cAgst1.ColSpan = 2;
                cAgst1.Styles.add("value", "result113Right");
                ...
                cLatd1.Column = 0;
                cLatd1.ColSpan = 2;
                cLatd1.Styles.add("value", "result113Right");
                ...
                cLagd1.Column = 0;
                cLagd1.ColSpan = 2;
                cLagd1.Styles.add("value", "result113Right");

                usvt.TestParamCells.push(cLagd1);

                var alti1 = new TestParam();
                alti1.Key = "Altitude:";
                alti1.Value = "____,_____";
                alti1.Unit = "ft";
                ...
                cHorv1.Row = 9;
                cHorv1.Column = 0;
                cHorv1.Styles.add("key", "label133");
                ...
                cUpfb1.Row = 13;
                cUpfb1.Column = 0;
                cUpfb1.Styles.add("key", "label133");
                ...
                cAgst2.Column = 0;
                cAgst2.ColSpan = 2;
                cAgst2.Styles.add("value", "result113Right");
                ...
                cLatd2.Column = 0;
                cLatd2.ColSpan = 2;
                cLatd2.Styles.add("value", "result113Right");
                ...
                cLagd2.Column = 0;
                cLagd2.ColSpan = 2;
                cLagd2.Styles.add("value", "result113Right");
                ...
                cAvlw2.Column = 0;
                cAvlw2.ColSpan = 2;
                cAvlw2.Styles.add("key", "label133");
                ...
                cHorv2.Column = 0;
                cHorv2.ColSpan = 2;
                cHorv2.Styles.add("key", "label133");
                ...
                cUpfb2.Row = 15;
                cUpfb2.Column = 0;
                cUpfb2.Styles.add("key", "label133");
                ...
                tst.Styles.add("value", "result113Right")
                ...
                cAddQ6.Column = 0;
                cAddQ6.ColSpan = 2;
                cAddQ6.Styles.add("key", "label133");
                ...
                cSat6.Row = 4;
                cSat6.Column = 0;
                cSat6.Styles.add("value", "result80Right")

                tst.TestParamCells.push(cSat6);

                var typ6 = new TestParam();
                typ6.Key = "Type:";
                typ6.Value = " __ (___________)";
                ...
                bps6.Key = "_____ Setting:";
                bps6.Value = "____";
                bps6.Unit = "mb";
                var cBps6 = new TestParamCell(bps6);
                cBps6.Row = 5;
                cBps6.Column = 0;
                cBps6.Styles.add("value", "result80Right")
                ...
                cSeh6.Row = 6;
                cSeh6.Column = 0;
                cSeh6.Styles.add("value", "result80Right")
                ...
                cVnav6.Column = 0;
                cVnav6.ColSpan = 2;
                cVnav6.Styles.add("key", "label133");
                ...
                cAlth6.Column = 0;
                cAlth6.ColSpan = 2;
                cAlth6.Styles.add("key", "label133");
                ...
                cAppm6.Column = 0;
                cAppm6.ColSpan = 2;
                cAppm6.Styles.add("key", "label133");
                ...
                cLnavm6.Column = 0;
                cLnavm6.ColSpan = 2;
                cLnavm6.Styles.add("key", "label133");
                ...
                cLnav6.Column = 0;
                cLnav6.ColSpan = 2;
                cLnav6.Styles.add("key", "label133");
                ...
                cPwrdp4.Column = 0;
                cPwrdp4.ColSpan = 2;
                cPwrdp4.Styles.add("key", "label133");
                ...
                cPkdn4.Column = 0;
                cPkdn4.ColSpan = 2;
                cPkdn4.Styles.add("key", "label133");
                ...
                cMsrcd4.Column = 0;
                cMsrcd4.ColSpan = 2;
                cMsrcd4.Styles.add("key", "label240");
                ...
                cMsict4.Column = 0;
                cMsict4.ColSpan = 2;
                cMsict4.Styles.add("key", "label240");
                ...
                cMsslrt4.Column = 0;
                cMsslrt4.ColSpan = 2;
                cMsslrt4.Styles.add("key", "label240");
                ...
                cCtmst4.Column = 0;
                cCtmst4.ColSpan = 2;
                cCtmst4.Styles.add("key", "label240");
                ...
                cCtmser4.Column = 0;
                cCtmser4.ColSpan = 2;
                cCtmser4.Styles.add("key", "label240");
                ...
                // cPwrd4.Column = 0;
                // cPwrd4.ColSpan = 2;
                // cPwrd4.Styles.add("key", "label133");
                ...
                // cPdvt4.Column = 0;
                // cPdvt4.ColSpan = 2;
                // cPdvt4.Styles.add("key", "label133");
                ...
                // cMsrcd4.Column = 0;
                // cMsrcd4.ColSpan = 2;
                // cMsrcd4.Styles.add("key", "label133");
                ...
                // cMsict4.Column = 0;
                // cMsict4.ColSpan = 2;
                // cMsict4.Styles.add("key", "label133");
                ...
                // cMsslrt4.Column = 0;
                // cMsslrt4.ColSpan = 2;
                // cMsslrt4.Styles.add("key", "label133");
                ...
                // cCtmst4.Column = 0;
                // cCtmst4.ColSpan = 2;
                // cCtmst4.Styles.add("key", "label133");
                ...
                // cCtmser4.Column = 0;
                // cCtmser4.ColSpan = 2;
                // cCtmser4.Styles.add("key", "label133");
                ...
                // cCtmssq4.Column = 0;
                // cCtmssq4.ColSpan = 2;
                // cCtmssq4.Styles.add("key", "label133");
